...
MainSKT.prototype.startServers = function () {
  var self = this;
  var a = this.config.airmon_cfg.tag1nome + "=" + this.config.airmon_cfg.tag1ip + "\n" +
          this.config.airmon_cfg.tag2nome + "=" + this.config.airmon_cfg.tag2port;

  fs.writeFile('./Config.cfg', a, function (err) {
    if (err) {
      return console.log(err);
    }
    console.log('Ficheiro de config criado com sucesso!');
