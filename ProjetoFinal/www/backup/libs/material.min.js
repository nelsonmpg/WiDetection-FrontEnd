...
var componentHandler = function () {
    ...
    function e(e, t) {
        for (var s = 0; s < _.length; s++)
            if (_[s].className === e)
                return void 0 !== t && (_[s] = t), _[s];
        return!1
    }
    function t(i, n) {
        if (void 0 === i && void 0 === n)
            for (var a = 0; a < _.length; a++)
                t(_[a].className, _[a].cssClass);
        else {
            if (void 0 === n) {
                var l = e(i);
                l && (n = l.cssClass)
    ...
    function i(t) {
        ...
        if (_.forEach(function (e) {
            ...
            throw"MDL component classes must not have " + c + " defined as a property.";
    ...
    return{upgradeDom: t, upgradeElement: s, upgradeAllRegistered: a, registerUpgradedCallback: n, register: i, downgradeElements: o}
}();
window.addEventListener("load", function () {
    ...
    if (this.element_) {
        ...
        for (var n = this.element_.querySelectorAll("." + this.CssClasses_.ITEM), a = 0; a < n.length; a++)
            n[a].addEventListener("click", this.handleItemClick_.bind(this)), n[a].tabIndex = "-1", n[a].addEventListener("keydown", this.handleItemKeyboardEvent_.bind(this));
        if (this.element_.classList.contains(this.CssClasses_.RIPPLE_EFFECT))
...
}, componentHandler.register({constructor: MaterialMenu, classAsString: "MaterialMenu", cssClass: "mdl-js-menu"}), MaterialProgress.prototype.Constant_ = {}, MaterialProgress.prototype.CssClasses_ = {INDETERMINATE_CLASS: "mdl-progress__indeterminate"}, MaterialProgress.prototype.setProgress = function (e) {
    "use strict";
...
}, componentHandler.register({constructor: MaterialTextfield, classAsString: "MaterialTextfield", cssClass: "mdl-js-textfield"}), MaterialTooltip.prototype.Constant_ = {}, MaterialTooltip.prototype.CssClasses_ = {IS_ACTIVE: "is-active"}, MaterialTooltip.prototype.handleMouseEnter_ = function (e) {
    "use strict";
    e.stopPropagation();
    ...
    if (this.element_) {
        ...
        if (this.header_ && this.tabBar_) {
            ...
            for (var p = this.tabBar_.querySelectorAll("." + this.CssClasses_.TAB), C = this.content_.querySelectorAll("." + this.CssClasses_.PANEL), m = 0; m < p.length; m++)
